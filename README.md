...
---
目录更新
/thinkphp(5.0.5 完整版 composer 获取最新版本) 

`Ht.Memorial`是一个基于`Thinkphp5`开发的后台管理系统，集成后台系统常用功能。

项目安装请参考`ThinkPHP`官方文档及下面的服务环境说明，数据库`sql`文件存放于项目/data/目录下。
...
server {
	listen 80;
	server_name jn.apprh.com;
	root /data/wwwroot/ht-memorial;
